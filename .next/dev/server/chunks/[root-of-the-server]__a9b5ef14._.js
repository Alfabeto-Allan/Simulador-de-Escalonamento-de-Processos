...
(()=>{
    const e = new Error("Cannot find module '../../../simulator/simulationEngine'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../../../simulator/Process'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
async function POST(req) {
    try {
        ...
        const processList = processos.map((p)=>new Process(p.id, p.chegada, p.execucao, p.prioridade, p.deadline));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a9b5ef14._.js.map